...
<body>
	...
	<tbody>
		...
		<c:forEach items="${page.items}" var="user">
			<tr>
				...
				<td>
					<shiro:hasRole name="admin">${user.lock_User}</shiro:hasRole>
					<shiro:lacksRole name="admin">您没有权限</shiro:lacksRole>
				</td>
				<td>
	...
	function doGoPage(pageNumber){
		var url = "${ctx}/showListUser?pageNumber="+pageNumber;
	...
	<div>
		<ul class="pager">
		    ...
		    <li><span><label class="label"><font color="blue">共${page.totalPage}页</font> </label></span> </li>
