...
<body>
	...
	<form:form commandName="user" action="login" method="post">
	    ...
	    <div class="panel-body">
			...
			<input type="text" class="form-control" name="username" placeholder="账号" size="22" value=''> <br>
			<input type="password" name="password" class="form-control" placeholder="密码" size="22"><br/>
			<input type="checkbox" name="rememberMe" value="true" placeholder="自动登录"><br/>
			<label>${error}</label>
	    </div>
